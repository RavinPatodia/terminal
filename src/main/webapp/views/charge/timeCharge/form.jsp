					...
					<form class="form-horizontal" role="form" id="searchForm">
						<div class="form-body">
							<div class="form-group">
								<div class="col-md-6" style="margin:5px 0px;" id="timeChargeId_div">
									<label class="col-md-3 control-label">计时规则编号</label>
									<div class="col-md-6">
										<input type="text" class="form-control " id="timeChargeId" />
									</div>
								</div>
								<div class="col-md-6" style="margin:5px 0px;">
									<label class="col-md-3 control-label">计时规则名称</label>
									<div class="col-md-6">
								...
								<div class="col-md- search_2" style="padding:0px;display:none;">
									    <div class="col-md-6" style="margin:5px 0px;">
										   ...
										   <div class="col-md-6">
											   <select class="bs-select form-control " style="display: none;" id="billingModel">
												   <option selected="selected" value="-1">请选择</option>
												   <option value="0">标准</option>
									            	<option value="1">时段</option>
									               <option value="2">昼夜</option>
									               <option value="3">昼夜二，跨昼夜不分开</option>
											  </select>
										  </div>
                                       </div>
                                       <!-- <div class="col-md-6" style="margin:5px 0px;">
