				...
				<div class="portlet box grey-cascade"
					...
					<div class="portlet-body">
						<div class="btn-group" role="group" aria-label="..."
							...
							<!-- <button type="button" class="btn btn-default tb_disabled">
								<span class="glyphicon glyphicon-ban-circle"></span> 禁用
							</button>
							<button type="button" class="btn btn-default tb_enable">
...
    "sAjaxSource": "${listUrl}",
    ...
    "aoColumns" : [ 
    {
        ...
        "mDataProp" : "timeChargeId",
    }, {
        "mDataProp" : "name",
        "sWidth": "400px"
    },  {
        "mDataProp" : "billingModel",
        "sWidth": "100px"
    }
    ],
    "columnDefs": [
...
function retrieveData( sSource, aoData, fnCallback ) {     
    //查询条件称加入参数数组     
    var timeChargeId =$("#timeChargeId").val();
    var name =$("#name").val();
    var billingModel =$("#billingModel").val();
    ...
    $.ajax( {     
        ...
        url: sSource,   
        dataType:"json",  
        data: "jsonParam="+JSON.stringify(aoData)+"&historyFlag=0&timeChargeId="
        +timeChargeId+"&name="+name+"&billingModel="+billingModel
