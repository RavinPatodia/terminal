...
park.dateTimeInit();
UIIdleTimeout.init();
recDblClick($('tbody > tr',$('#favourable')),$('#show'),pageUrl.charge_chargeRec_editAndDbl,$('#showForm'));
...
var dataTable_config = {//jquery_datatable插件的默认参数配置
    //下面设置数据栏目是否可排序
    "bServerSide": true,
    "sAjaxSource": pageUrl.charge_chargeRec_list,
...
function retrieveData( sSource, aoData, fnCallback ) {     
    ...
    var tChargeRuleName =$("#tChargeRuleName").val();
