						...
						<div class="form-body">
							<div class="form-group">
								...
								<div class="col-md- search_2" style="padding:0px;display:none;">
									...
									<div class="col-md-6" style="margin:5px 0px;">
										<label class="col-md-3 control-label">删除时间</label>
										<div class="col-md-8">
											<div class="input-group date-picker input-daterange" data-date="10-11-2012" data-date-format="mm-dd-yyyy">
												<input type="text" class="form-control input-sm" name="from" id="dtDelTimeFrom">
												<span class="input-group-addon">
												至 </span>
												<input type="text" class="form-control input-sm" name="to" id="dtDelTimeTo">
											</div>
										</div>
									</div>
								</div>
