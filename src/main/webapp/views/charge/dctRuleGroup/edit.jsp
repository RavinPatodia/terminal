							...
							<form class="form-horizontal" role="form" id="editForm">
								<div class="form-body">
									<div class="form-group">
										...
										<div class="col-md-6"><input type="text" readonly="readonly" class="form-control normal-input" name="groupId" fill="obj.groupId">
										</div>
									</div>

									<div class="form-group">
										<label class="col-md-4 control-label">优惠规则组名称</label>
										<div class="col-md-6"><input type="text" class="form-control normal-input" name="name" fill="obj.name"></div>
									</div>
									
									<div class="form-group">
										<label class="col-md-4 control-label">描述</label>
										<div class="col-md-6"><textarea class="form-control normal-input" id="message" rows="3" name="describion" fill="obj.describion"></textarea></div>
									</div>
									<div class="form-group">
											<label class="col-md-4 control-label">组内优惠规则</label>
											<div class="col-md-6">
												<select multiple="multiple"  class="multi-select"  name="dctRules">
												</select>
											</div>
									</div>
	...
	var bindSubmit = function(){
		$("#edit_save").on("click",function(){
			...
			$("#edit_save").prop('disabled',true);
			 $.ajax({
		       type: "POST",
		       url: pageUrl.charge_dctRuleGroup_edit,
