					...
					<form class="form-horizontal" role="form" id="searchForm">
						<div class="form-body">
							<div class="form-group">
								<div class="col-md-6" style="margin:5px 0px;" id="dctRuleGroup_div">
									<label class="col-md-3 control-label">优惠规则组编号</label>
									<div class="col-md-8">
										<input type="text" class="form-control input-sm" id="tGroupId"/>
									</div>
								</div>
								<div class="col-md-6" style="margin:5px 0px;">
									<label class="col-md-3 control-label">优惠规则组名称</label>
									<div class="col-md-8">
										<input type="text" class="form-control input-sm" id="tGroupName"/>
									</div>
								</div>
