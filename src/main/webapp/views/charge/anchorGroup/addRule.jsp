					...
					<div class="col-md-12">
							<div class="form-body">
								...
								<div class="form-group col-md-12">
									<label class="col-md-4 control-label col-md-offset-0">组内长期规则</label>
									<div class="col-md-8">
										<div class="form-group container muti-wrap col-md-12">
												...
												<div class="col-md-12" style="padding:0px;">
													<div class="col-md-6" style="padding:0px;">
														<input type="hidden" name="anchorRentPKs" class="form-control value_text">
													</div>
												</div>
											</div>
									</div>
...
var addRule=function(){
	...
	var bindSubmit = function(){
		$("#charge_addRule_save").on("click",function(){
			 $.ajax({
		       type: "POST",
		       url: pageUrl.charge_anchorGroup_editRulesInGroup,
