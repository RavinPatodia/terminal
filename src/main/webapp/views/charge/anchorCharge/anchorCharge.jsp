			...
			<div class="portlet box grey-cascade"
				...
				<div class="portlet-body" style="position:relative;">
					<div class="btn-group" role="group" aria-label="...">
						<a class="btn btn-default btn-sm tb_add" data-toggle="modal" href="#add">
...
UIIdleTimeout.init();
add.init();
edit.init($("#favourable"),$("#modify"),pageUrl.charge_anchorRent_editAndDbl);
$('.tb_del').delUseDialog($("#favourable"),pageUrl.charge_anchorRent_del,"长期收费");
//那个表格的初始化
;(function () {
var dataTable_config = {//jquery_datatable插件配置
    //下面设置数据栏目是否可排序
    "bServerSide": true,
    "sAjaxSource": pageUrl.charge_anchorRent_list,
...
function retrieveData( sSource, aoData, fnCallback ) {     
    //查询条件称加入参数数组     
    var anchorRentId=$("#anchorRentId").val();
    var name =$("#name").val();
    $.ajax( {     
        type: "POST",
        url: sSource,   
        dataType:"json",  
        data: "jsonParam="+JSON.stringify(aoData)+"&anchorRentId="
        +anchorRentId+"&name="+name,
