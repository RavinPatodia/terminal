...
<body class="page-header-fixed page-quick-sidebar-over-content ">
	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
				...
				<div class="portlet box grey-cascade"
					...
					<div class="portlet-body" style="position:relative;">
						<div class="btn-group" role="group" aria-label="...">
							...
							<button type="button" class="btn btn-sm btn-default tb_del" style="display: none" >
			...
			<!--这个页面的弹窗都在这里 start-->
			<jsp:include page="/views/caradmission/admissRec/show.jsp" />
			<jsp:include page="/views/caradmission/admissRec/edit.jsp" />
			<!--这个页面的弹窗都在这里 end-->
		</div>
	</div>
	<!-- END CONTAINER -->
...
<script type="text/javascript">
	$(function(){
		...
		var editAndDblUrl = pageUrl.caradmission_admissRec_editAndDblUrl;
...
var admissRecDblClick = function(obj,dialog,showUrl,showForm){
	...
	var initDrop=function(){
		$('.car_type').select2({
	        ...
	        formatSearching: "查询中...",
	        ajax: {
	            url: pageUrl.caradmission_admissRec_type+"t="+ Math.random(),
	            dataType: 'json',
	            delay: 500,
		...
		$('.car_licensePlate').select2({
	        ...
	        formatSearching: "查询中...",
	        ajax: {
	            url: pageUrl.caradmission_admissRec_licensePlate+"t="+ Math.random(),
	            dataType: 'json',
	            delay: 500,
	            data: function (term, page) {
	                return {
