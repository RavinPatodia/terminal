...
<body class="page-header-fixed page-quick-sidebar-over-content ">
	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			...
			<!--这个页面的弹窗都在这里 start-->
			<jsp:include page="/views/caradmission/delParkingRec/del.jsp" />
			<jsp:include page="/views/caradmission/delParkingRec/show.jsp" />
			<jsp:include page="/views/caradmission/delParkingRec/recover.jsp" />
			<!--这个页面的弹窗都在这里 end-->
		</div>
	</div>
