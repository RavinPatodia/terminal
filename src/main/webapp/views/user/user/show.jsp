			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" style="font-family: 'Microsoft Yahei'">
						<span class="glyphicon glyphicon-plus"></span> 查看客户信息
					</h4>
				</div>
												...
												<div class="tab-content">
													<div class="tab-pane active" id="tab_6_1">
														...
														<div class="form-group">
															...
															<div class="col-md-6">
																	<p class="form-control-static" fill="obj.hasParkingSpaces" data-type="boolean" data-true="是" data-false="否" id="hasSpaces"></p>
															</div>
														</div>
													</div>
													<div class="tab-pane fade" id="tab_6_2">
														<div class="form-group">
															...
															<div class="col-md-6">
																<label class="form-control-static show" fill="obj.addrStr"></label>
															</div>
														</div>
														<div class="form-group">
													...
													<div class="tab-pane fade" id="tab_6_3">
														...
														<div class="form-group">
															<label class="col-md-4 control-label">会员开始时间</label>
															<div class="col-md-6">
																<label class="form-control-static show" fill="obj.beginTime">
																</label>
															</div>
														</div>
														<div class="form-group">
															<label class="col-md-4 control-label">会员失效时间</label>
															<div class="col-md-6">
													...
													<div class="tab-pane fade" id="tab_6_4">
														<table class="table table-bordered table-hover" id="userInfoTable">
															<thead>
																<tr>
																	<th>车牌号码</th>
																	<th>车牌类型</th>
...
<script>
var userInfo = function(jsonData){
