...
<div id="add1" class="modal fade" tabindex="-1" data-width="400"data-backdrop="static" data-keyboard="false">
	...
	<div class="modal-dialog">
		...
		<form class="form-horizontal" role="form" id="addBayonet">
				<div class="row">
					<div class="col-md-12">
							<div class="form-body">
								<div class="form-group">
									...
									<div class="col-md-6">
										<input class="form-control parkId" name="parkId" id="parkId">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<input  class="form-control name" name="name" id="name">
									</div>
								</div>
								<div class="form-group">
...
var addBayonet=function(){
	...
	var bindSubmit=function(){
		$('#bayonet_add_save').on('click',function(){
			//验证所有组件的方法
			if(!check($("#addBayonet")).form()) return;
			//判断是否存在不合法的输入
			if($('.has-error').length<=0){
				$.ajax({
			        type: "POST",
			        url: pageUrl.device_bayonet_addBayonet,
			        data:$('#addBayonet').serialize(),// 你的formid
			        async: false,
			        ...
			        success: function(data) {
			        	...
			        	if(!obj.validateResult){
			        		...
			        		$("#addBayonet").clearValidator();
			        		$("#addBayonet").fillValidator(obj.validateMsg);
			        		//alert(obj.msg);
			        		return;
			        	}
			        	if(obj.success){
