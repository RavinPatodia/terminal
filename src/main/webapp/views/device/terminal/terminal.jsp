...
<body class="page-header-fixed page-quick-sidebar-over-content ">
	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			...
			<!--这个页面的弹窗都在这里 start-->
			<jsp:include page="/views/device/terminal/add.jsp" />
			<jsp:include page="/views/device/terminal/edit.jsp" />
			<jsp:include page="/views/device/terminal/show.jsp" />
			<!--这个页面的弹窗都在这里 end-->
		</div>
	</div>
	<!-- END CONTAINER -->
...
function retrieveData( sSource, aoData, fnCallback ) {     
    ...
    $.ajax( {     
        ...
        url: sSource,   
        dataType:"json",  
        data: "jsonParam="+JSON.stringify(aoData)+"&deviceId="+deviceId+"&name="+name,
