				...
				<div class="row">
						<div class="portlet light bordered">
							...
							<div class="portlet-body">
								<div id="chart_3" class="chart" style="height: 380px;">
								</div>
							</div>
						</div>
				</div>
...
var search=function(){
	 $.ajax({
			url: "/terminal/report/charRecOfMonth/getMaxYear",   
		    dataType:"json",  
		    data:"", 
			type: 'POST',
			success: function(data) { 
				if(data==null){
					$('.caption').find("span").html("没有收费记录");
				}else{
					$('.caption').find("span").html(data+"年月收费统计");
				}
...
var actualPayOfMouth=function(year){
	 $.ajax({
		url: "/terminal/report/charRec/getActualPayOfMouth/"+year,   
	    dataType:"json",  
	    data:"", 
		type: 'POST',
		success: function(data) { 
