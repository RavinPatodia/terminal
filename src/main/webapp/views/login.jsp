...
<link href="<%=request.getContextPath()%>/assets/admin/pages/css/login-soft.css" rel="stylesheet" type="text/css"/>
...
<div class="logo">
	<a href="index.jsp">
	<font size="+3"><b> 智能停车场管理系统</b></font>
	</a>
</div>
<!-- END LOGO -->
...
<div class="content">
	...
	<form class="login-form" action="<%=request.getContextPath()%>/admin/login" method="post">
		...
		<div class="forget-password">
			<h4>忘记用户名/密码？</h4>
			<p>
				单击<a href="javascript:;" id="forget-password">
				此处 </a>
				重置密码
			</p>
		</div>
	...
	<form class="register-form" action="index.jsp" method="post">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix" type="text" placeholder="所在城市" name="city"/>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<label>
			<input type="checkbox" name="tnc"/> 我同意该 <a href="#">
			服务条款 </a>
			和 <a href="#">
			隐私政策 </a>
			</label>
...
jQuery(document).ready(function() {     
  ...
  Demo.init();
       ...
       $.backstretch([
        "<%=request.getContextPath()%>/assets/admin/pages/media/bg/1.jpg",
        "<%=request.getContextPath()%>/assets/admin/pages/media/bg/2.jpg",
        "<%=request.getContextPath()%>/assets/admin/pages/media/bg/3.jpg",
        "<%=request.getContextPath()%>/assets/admin/pages/media/bg/4.jpg"
        ], {
          fade: 1000,
          duration: 8000
    }
	...
	var msg="${errorMsg}";
	if(msg!=""){
		$('.form-title').after('<div class="alert alert-danger"><button class="close" data-close="alert"></button><span>'+msg+' </span></div>');
	}
});
</script>
<!-- END JAVASCRIPTS -->
