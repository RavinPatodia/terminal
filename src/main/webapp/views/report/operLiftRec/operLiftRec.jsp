	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			<div class="page-content">
				...
				<!-- START POTTLEX demo2------------>
				<div class="portlet box grey-cascade" style=" border-top: 1px solid #b1bdbd">
									...
									<div class="portlet light bordered">
										<div class="portlet-title">
											<div class="caption">
												...
												<span class="caption-subject bold uppercase font-green-haze"> 操作员抬杆记录统计图</span>
			...
			<!--这个页面的弹窗都在这里 start-->
			<jsp:include page="/views/report/operLiftRec/del.jsp" />
			<!--这个页面的弹窗都在这里 end-->
		</div>
	</div>
	<!-- END CONTAINER -->
...
jQuery(document).ready(function() {
	...
	(function () {
		var dataTable_config = {//jquery_datatable插件的默认参数配置
		    //下面设置数据栏目是否可排序
		    "bServerSide": true,
		    "sAjaxSource": pageUrl.report_operLiftRec_list,
...
$(function() {
	...
	$('.tb_export').bind('click',function(){
		 var startTime =$("#startTime").val();
		 var endTime =$("#endTime").val();
		 $(this).attr('href',"/park/report/operLiftRec/export?startTime="+startTime+"&endTime="+endTime);
	});
	//导出操作员抬杆记录
	$('.tb_export_data').bind('click',function(){
		 ...
		 var endTime =$("#endTime").val();
		 var operId=$('#operId').val();
		 $(this).attr('href',"/park/report/operLiftRec/exportData?startTime="+startTime+"&endTime="+endTime+"&operId="+operId);
	});
});
...
var search=function(){
	 ...
	 var endTime =$("#endTime").val();
	 $.ajax({
		url: pageUrl.report_operLiftRec_search,   
	    dataType:"json",  
