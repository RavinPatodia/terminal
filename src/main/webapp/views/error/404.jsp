...
<link href="<%=request.getContextPath()%>/assets/admin/pages/css/error.css" rel="stylesheet" type="text/css"/>
...
<div class="page-inner">
	<img src="<%=request.getContextPath()%>/assets/admin/pages/media/pages/earth.jpg" class="img-responsive" alt="">
</div>
