 ...
 *
 */
public interface AdmissionRecDao extends BaseDao<AdminssionRec> {
	/**
	...
	public List<AdminssionRec> findByOutOperAndOutTimeBetween(Operater operId,
			Date workTime, Date offWorkTime);
