...
public class Global {
	...
	private static ParkingEnvir config;
	
	/**
	 * 属性文件加载对象
	 */
	private static PropertiesLoader propertiesLoader = new PropertiesLoader("park.properties");
	/**
	 * 获取配置
	 */
	...
	public static ParkingEnvir getConfig() {
		return config;
	}

	public static void setConfig(ParkingEnvir config) {
